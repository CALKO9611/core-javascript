...
// - elementNode.hasAttribute(name) – 속성 존재 여부 확인 : true / false 반환
...
// first.setAttrinbute('some', '');  // setAttribute로 some 삭제 


// - elementNode.attributes – 열거 가능한(iterable) 속성 집합을 반환함
console.log(first.attributes); // namedNodemap 객체가 생성
...
first.dataset.play = 'playing'; // set  , data-play="playing"
